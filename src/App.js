  ...
  return (
    <div className="App">
      ...
      <header>
        ...
        {/* <p>Store Number: {storeData["Store Number"]}</p>
        <p>{storeData["Address"]}</p>
        <p>Phone: {storeData["Phone Number"]}</p> */}
      </header>
      <div className='data-dispaly-block'>
      ...
      <footer>
        <p>Subtotal: {storeData.Subtotal}</p>
        <p>Payment Method: {storeData["Payment Method"]}</p>
      </footer>
    </div>
    </div>
  );
